...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'client/bower_components/noty/js/noty/packaged/jquery.noty.packaged.js',
      ...
      'client/bower_components/bowser/src/bowser.js',
      'client/bower_components/angular-gettext-sg/dist/angular-gettext.js',
      'client/bower_components/fastclick/lib/fastclick.js',
      'client/bower_components/bootcards/dist/js/bootcards.js',
      'client/bower_components/respond/dest/respond.src.js',
